...
\begin{document}
  ...
  O número de épocas terá o mesmo número de valores supervisionado, então o treino executará 1 vez para cada observação.
        ...
        \subsection{Algoritmo de treino e validação backpropagation}
            ...
            \end{itemize}
            \begin{enumerate}
                \item Inicializa-se uma fila circular de grafos 'rna' de tamanho L, K[L].
                \item Inicializa-se uma fila circular com zeros, do tipo real, $m.s.e$ de tamanho L, mse[L].
                \item Copiar 'rna'[][] para K[0].
                \item Inicializar aleatoriamente todos os pesos sinápticos de K[0].
                \item Aplicar Y
                \item Calcula se as saídas dos neurônios, começando da primeira canada de entrada até o neurônio de saída.
                \item LAÇO: Enquanto soma (mse[0] à mse[$\frac{L}{2}$]) for maior que (mse[$\frac{L}{2} +1$] à mse[L]) 
                \item inicializa-se todos os pesos da rede com valores aleatoriamente pequenos.
                 sinápticos
                \item Enquanto $m.s.e$ atual for menor do que $l$ de $k.o$ de parada, faça:
